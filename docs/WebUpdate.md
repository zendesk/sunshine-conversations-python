...
web_update_instance = WebUpdate.from_json(json)
# print the JSON string representation of the object
print(WebUpdate.to_json())

# convert the object into a dict
web_update_dict = web_update_instance.to_dict()
# create an instance of WebUpdate from a dict
web_update_from_dict = WebUpdate.from_dict(web_update_dict)
```
