...
**page_id** | **str** | Facebook Page App ID. Returned on successful *messenger* and *instagram* integrations.  | [optional] 
...
**user_id** | **str** | The twitter userId or Facebook userId. Returned on successful *twitter* and *instagram* integrations.  | [optional] 
...
**signing_key** | **str** | The signing key of your MessageBird account. Used to validate the webhooks&#39; origin. (Optional) Used for *messagebird* integrations.  | [optional] 
...
**business_username** | **str** | Instagram Business account username.  | [optional] 
