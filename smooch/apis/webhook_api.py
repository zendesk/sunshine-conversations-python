...
class WebhookApi(object):
    ...
    def create_webhook_with_http_info(self, app_id, webhook_create_body, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/webhooks', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_webhook_with_http_info(self, app_id, webhook_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/webhooks/{webhookId}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_webhook_with_http_info(self, app_id, webhook_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/webhooks/{webhookId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_webhooks_with_http_info(self, app_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/webhooks', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_webhook_with_http_info(self, app_id, webhook_id, webhook_update_body, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/webhooks/{webhookId}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
