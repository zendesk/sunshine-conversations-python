...
class ConversationApi(object):
    ...
    def delete_message_with_http_info(self, app_id, user_id, message_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/appusers/{userId}/messages/{messageId}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_messages_with_http_info(self, app_id, user_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/appusers/{userId}/messages', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_messages_with_http_info(self, app_id, user_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/appusers/{userId}/messages', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def post_message_with_http_info(self, app_id, user_id, message_post_body, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/appusers/{userId}/messages', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def reset_unread_count_with_http_info(self, app_id, user_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/appusers/{userId}/conversation/read', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def trigger_typing_activity_with_http_info(self, app_id, user_id, typing_activity_trigger_body, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/appusers/{userId}/conversation/activity', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
