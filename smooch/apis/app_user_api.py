...
class AppUserApi(object):
    ...
    def get_app_user_auth_code_with_http_info(self, app_id, user_id, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/appusers/{userId}/authcode', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_app_user_business_system_ids_with_http_info(self, app_id, user_id, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/appusers/{userId}/businesssystems', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_link_requests(self, app_id, user_id, integration_ids, **kwargs):
        ...
        :param str app_id: Identifies the app. (required)
        :param str user_id: Identifies the user. Can be either the smoochId or the userId. (required)
        :param str integration_ids: Comma separated list of integration IDs (required)
    ...
    def get_link_requests_with_http_info(self, app_id, user_id, integration_ids, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/appusers/{userId}/linkrequest', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
