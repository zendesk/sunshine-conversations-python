...
class AppUserApi(object):
    ...
    def app_user_device_update(self, app_id, user_id, device_id, app_user_device_update_body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.app_user_device_update(app_id, user_id, device_id, app_user_device_update_body, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.app_user_device_update_with_http_info(app_id, user_id, device_id, app_user_device_update_body, **kwargs)
        else:
            (data) = self.app_user_device_update_with_http_info(app_id, user_id, device_id, app_user_device_update_body, **kwargs)
            return data

    def app_user_device_update_with_http_info(self, app_id, user_id, device_id, app_user_device_update_body, **kwargs):
        """
        Update specified device information.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.app_user_device_update_with_http_info(app_id, user_id, device_id, app_user_device_update_body, callback=callback_function)
        ...
        all_params = ['app_id', 'user_id', 'device_id', 'app_user_device_update_body']
        ...
        if ('app_id' not in params) or (params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `app_user_device_update`")
        ...
        return self.api_client.call_api('/apps/{appId}/appusers/{userId}/devices/{deviceId}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_app_user_profile_with_http_info(self, app_id, user_id, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/appusers/{userId}/profile', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_app_user_with_http_info(self, app_id, user_id, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/appusers/{userId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_app_user_entity_ids_with_http_info(self, app_id, user_id, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/appusers/{userId}/channels', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def link_app_user_with_http_info(self, app_id, user_id, app_user_link_body, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/appusers/{userId}/channels', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def post_image_message_with_http_info(self, app_id, user_id, source, role, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/appusers/{userId}/images', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def pre_create_app_user_with_http_info(self, app_id, app_user_pre_create_body, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/appusers', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def unlink_app_user_with_http_info(self, app_id, user_id, channel, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/appusers/{userId}/channels/{channel}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_app_user_with_http_info(self, app_id, user_id, app_user_update_body, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/appusers/{userId}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
