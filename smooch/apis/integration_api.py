...
class IntegrationApi(object):
    ...
    def create_integration_with_http_info(self, app_id, integration_create_body, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/integrations', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def create_integration_menu_with_http_info(self, app_id, integration_id, menu_create_body, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/integrations/{integrationId}/menu', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_integration_with_http_info(self, app_id, integration_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/integrations/{integrationId}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_integration_menu_with_http_info(self, app_id, integration_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/integrations/{integrationId}/menu', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_integration_with_http_info(self, app_id, integration_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/integrations/{integrationId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_integration_menu_with_http_info(self, app_id, integration_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/integrations/{integrationId}/menu', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_integrations_with_http_info(self, app_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/integrations', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_integration(self, app_id, integration_id, integration_update_body, **kwargs):
        ...
        :param str app_id: Identifies the app. (required)
        :param str integration_id: Identifies the integration. (required)
        :param IntegrationUpdate integration_update_body: Body for a updateIntegration request. Additional arguments are necessary based on integration type. For detailed instructions, visit our [official docs](https://docs.smooch.io/rest/#create-integration)  (required)
        :return: IntegrationResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_integration_with_http_info(self, app_id, integration_id, integration_update_body, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/integrations/{integrationId}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_integration_menu_with_http_info(self, app_id, integration_id, menu_update_body, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/integrations/{integrationId}/menu', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_integration_profile_with_http_info(self, app_id, integration_id, integration_profile_body, **kwargs):
        ...
        return self.api_client.call_api('/v1/apps/{appId}/integrations/{integrationId}/profile', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
