...
class MenuApi(object):
    ...
    def delete_menu_with_http_info(self, app_id, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/menu', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_menu_with_http_info(self, app_id, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/menu', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_menu_with_http_info(self, app_id, menu_update_body, **kwargs):
        ...
        return self.api_client.call_api('/apps/{appId}/menu', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
