...
class AppUser(object):
    ...
    """
    def __init__(self, id=None, user_id=None, given_name=None, surname=None, email=None, signed_up_at=None, properties=None, conversation_started=None, credential_required=None, clients=None, pending_clients=None):
        """
    ...
    def credential_required(self):
        """
        Gets the credential_required of this AppUser.
        Flag indicating if the appUser is secured by a JSON Web Token or not.

        :return: The credential_required of this AppUser.
        :rtype: bool
        """
    ...
    def credential_required(self, credential_required):
        """
        Sets the credential_required of this AppUser.
        Flag indicating if the appUser is secured by a JSON Web Token or not.

        :param credential_required: The credential_required of this AppUser.
        :type: bool
        """
