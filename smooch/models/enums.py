...
class Enums(object):
    ...
    """
    def __init__(self, action_size=None, action_type=None, business_system_type=None, confirmation_type=None, conversation_activity_type=None, image_aspect_ratio=None, integration_status=None, integration_type=None, menu_item_type=None, message_item_size=None, message_type=None, role=None, webhook_triggers=None, deployment_hosting=None, deployment_status=None, deployment_activation_method=None):
        """
    ...
    def deployment_status(self, deployment_status):
        ...
        :type: str
        """
        allowed_values = ["starting", "unregistered", "registered", "integrated", "pending", "deleting", "error"]
