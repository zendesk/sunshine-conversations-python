...
class MessagePost(object):
    ...
    """
    def __init__(self, role=None, type=None, name=None, email=None, avatar_url=None, metadata=None, payload=None, text=None, media_url=None, media_type=None, alt_text=None, items=None, actions=None, block_chat_input=None, display_settings=None, fields=None, destination=None, override=None, coordinates=None, location=None):
        """
    ...
    def alt_text(self):
        """
        Gets the alt_text of this MessagePost.
        ...
        :return: The alt_text of this MessagePost.
        :rtype: str
        """
    ...
    def alt_text(self, alt_text):
        """
        Sets the alt_text of this MessagePost.
        An optional description of the image or the file for accessibility purposes. The field will be saved by default with the file name as the value.

        :param alt_text: The alt_text of this MessagePost.
        :type: str
        """
