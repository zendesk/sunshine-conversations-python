...
class MessagePost(object):
    ...
    """
    def __init__(self, role=None, type=None, name=None, email=None, avatar_url=None, destination=None, metadata=None, payload=None, text=None, media_url=None, media_type=None, items=None, actions=None):
        """
