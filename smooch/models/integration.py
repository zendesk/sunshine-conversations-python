...
class Integration(object):
    ...
    """
    def __init__(self, id=None, type=None, page_access_token=None, app_id=None, app_secret=None, webhook_secret=None, page_id=None, account_sid=None, auth_token=None, phone_number_sid=None, phone_number=None, name=None, token=None, uri=None, channel_access_token=None, bot_name=None, encoding_aes_key=None, from_address=None, certificate=None, password=None, auto_update_badge=None, production=None, server_key=None, sender_id=None, consumer_key=None, consumer_secret=None, access_token_key=None, access_token_secret=None, user_id=None, username=None, api_key=None, domain=None, incoming_address=None, access_key=None, originator=None, brand_color=None, conversation_color=None, action_color=None, display_style=None, button_icon_url=None, integration_order=None, business_name=None, business_icon_url=None, background_image_url=None):
        """
