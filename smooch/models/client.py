...
class Client(object):
    ...
    """
    def __init__(self, id=None, active=None, last_seen=None, platform=None, integration_id=None, push_notification_token=None, app_version=None, display_name=None, info=None, raw=None):
        """
