...
class Init(object):
    ...
    """
    def __init__(self, device=None, user_id=None):
        """
    ...
    def user_id(self):
        ...
        :return: The user_id of this Init.
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this Init.
        The app user's userId. If specified, this ID can be used to invoke APIs. If left blank, an ID will automatically be generated. 

        :param user_id: The user_id of this Init.
        :type: str
        """
