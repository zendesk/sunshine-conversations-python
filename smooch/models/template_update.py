...
class TemplateUpdate(object):
    ...
    def __init__(self, name=None, message=None):
        """
        TemplateUpdate - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this TemplateUpdate.
        ...
        :return: The name of this TemplateUpdate.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this TemplateUpdate.
        :type: str
        """
    ...
    def message(self):
        """
        Gets the message of this TemplateUpdate.
        The message sent when referencing the template via syntax.

        :return: The message of this TemplateUpdate.
        :rtype: Message
        """
    ...
    def message(self, message):
        """
        Sets the message of this TemplateUpdate.
        The message sent when referencing the template via syntax.

        :param message: The message of this TemplateUpdate.
        :type: Message
        """
