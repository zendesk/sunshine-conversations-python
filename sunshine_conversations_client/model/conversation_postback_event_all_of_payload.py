...
class ConversationPostbackEventAllOfPayload(BaseModel):
    """
    The payload of the event. The contents of this object depend on the type of event.
    """ # noqa: E501
    postback: Optional[PostbackWebhook] = Field(default=None, description="The postback associated with the event.")
    conversation: Optional[ConversationTruncated] = Field(default=None, description="The conversation linked to the postback.")
    user: Optional[User] = Field(default=None, description="The user that triggered the postback.")
    source: Optional[SourceWithCampaignWebhook] = Field(default=None, description="The source of the postback.")
    __properties: ClassVar[List[str]] = ["postback", "conversation", "user", "source"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "postback": PostbackWebhook.from_dict(obj["postback"]) if obj.get("postback") is not None else None,
