...
class MetaConversionEventPayload(BaseModel):
    """
    ...
    """ # noqa: E501
    data: List[Dict[str, Any]] = Field(description="The array of conversion events to be sent to Meta's conversion events API.")
