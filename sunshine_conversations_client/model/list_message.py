...
class ListMessage(object):
    ...
    def __init__(self, type='list', block_chat_input=None, items=None, actions=None, local_vars_configuration=None):  # noqa: E501
    ...
    def block_chat_input(self):
        """Gets the block_chat_input of this ListMessage.  # noqa: E501
        ...
        :return: The block_chat_input of this ListMessage.  # noqa: E501
        :rtype: bool
        """
    ...
    def block_chat_input(self, block_chat_input):
        """Sets the block_chat_input of this ListMessage.

        When set to true, the chat input will be disabled on supported client implementations when the message is the most recent one in the history. Can be used for guided flows or to temporarily disable the user's ability to send messages in the conversation.  # noqa: E501

        :param block_chat_input: The block_chat_input of this ListMessage.  # noqa: E501
        :type: bool
        """
