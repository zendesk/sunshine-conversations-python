...
class AttachmentResponse(BaseModel):
    ...
    AttachmentResponse
    """ # noqa: E501
    attachment: Optional[AttachmentSchema] = Field(default=None, description="The uploaded attachment object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attachment": AttachmentSchema.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None
        })
        return _obj
