...
class Conversation(object):
    ...
    def __init__(self, id=None, type=None, metadata=Undefined(), active_switchboard_integration=Undefined(), pending_switchboard_integration=Undefined(), is_default=None, display_name=Undefined(), description=Undefined(), icon_url=Undefined(), business_last_read=Undefined(), last_updated_at=Undefined(), created_at=None, local_vars_configuration=None):  # noqa: E501
