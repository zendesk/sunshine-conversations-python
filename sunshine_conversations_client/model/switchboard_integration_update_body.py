...
class SwitchboardIntegrationUpdateBody(BaseModel):
    """
    ...
    integration_id: Optional[StrictStr] = Field(default=None, description="The id of the integration to link to the switchboard integration. Must be used when linking a custom integration. Can't provide both `integrationId` and `integrationType`.", alias="integrationId")
    integration_type: Optional[StrictStr] = Field(default=None, description="The type of the integration to link to the switchboard integration. Must be used when linking an OAuth integration. Can't provide both `integrationId` and `integrationType`.", alias="integrationType")
