...
class Messenger(Integration):
    ...
    def __init__(self, type='messenger', page_access_token=Undefined(), app_id=None, app_secret=Undefined(), page_id=None, page_name=None, default_responder_id=Undefined(), default_responder=Undefined(), local_vars_configuration=None, **kwargs):  # noqa: E501
