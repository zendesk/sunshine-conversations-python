...
class Content(object):
    ...
    def __init__(self, type='template', text=None, html_text=None, block_chat_input=None, markdown_text=None, actions=None, payload=None, items=None, display_settings=None, media_url=None, media_size=None, media_type=None, alt_text=None, attachment_id=None, submitted=None, fields=None, text_fallback=None, coordinates=None, location=None, template=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def html_text(self):
        """Gets the html_text of this Content.  # noqa: E501
        ...
        :return: The html_text of this Content.  # noqa: E501
        :rtype: str
        """
    ...
    def html_text(self, html_text):
        """Sets the html_text of this Content.

        HTML text content of the message. Can be provided in place of `text`. Cannot be used with `markdownText`. If no `text` is provided, will be converted to `text` upon reception to be displayed on channels that do not support rich text. See [rich text](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/structured-messages/#rich-text) documentation for more information.  # noqa: E501

        :param html_text: The html_text of this Content.  # noqa: E501
        :type: str
        """
    ...
    def markdown_text(self):
        """Gets the markdown_text of this Content.  # noqa: E501
        ...
        :return: The markdown_text of this Content.  # noqa: E501
        :rtype: str
        """
    ...
    def markdown_text(self, markdown_text):
        """Sets the markdown_text of this Content.

        Markdown text content of the message. Can be provided in place of `text`. Cannot be used with `htmlText`. Will be converted to `htmlText` upon reception. If converted `htmlText` exceeds 4096 characters, the message will be rejected. If no `text` is provided, will be converted to `text` upon reception to be displayed on channels that do not support rich text. See [rich text](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/structured-messages/#rich-text) documentation for more information.  # noqa: E501

        :param markdown_text: The markdown_text of this Content.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def actions(self, actions):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                actions is not None and len(actions) > 10):
            raise ValueError("Invalid value for `actions`, number of items must be less than or equal to `10`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def payload(self):
        ...
        The payload of a [reply button](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/structured-messages/#reply-buttons) response message.  # noqa: E501
    ...
    def items(self, items):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                items is not None and len(items) > 10):
            raise ValueError("Invalid value for `items`, number of items must be less than or equal to `10`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def fields(self, fields):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                fields is not None and len(fields) > 20):
            raise ValueError("Invalid value for `fields`, number of items must be less than or equal to `20`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                fields is not None and len(fields) < 1):
    ...
    def template(self):
        ...
        The whatsapp template message to send. For more information, consult the [guide](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/message-overrides/#template-messages). `schema` must be set to `whatsapp`.  # noqa: E501
