...
class Content(object):
    ...
    def __init__(self, type='location', text=None, actions=None, items=None, display_settings=None, media_url=None, media_size=None, media_type=None, alt_text=None, block_chat_input=None, fields=None, text_fallback=None, coordinates=None, location=None, local_vars_configuration=None):  # noqa: E501
