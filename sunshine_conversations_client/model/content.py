...
class Content(object):
    ...
    def __init__(self, type='template', text=None, actions=None, payload=None, items=None, display_settings=None, media_url=None, media_size=None, media_type=None, alt_text=None, submitted=None, block_chat_input=None, fields=None, text_fallback=None, coordinates=None, location=None, template=None, local_vars_configuration=None):  # noqa: E501
