...
class TwitterAllOf(object):
    ...
    def __init__(self, type='twitter', tier=None, env_name=None, consumer_key=None, consumer_secret=Undefined(), access_token_key=None, access_token_secret=Undefined(), local_vars_configuration=None):  # noqa: E501
