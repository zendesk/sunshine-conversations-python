...
class PostbackWebhook(BaseModel):
    """
    PostbackWebhook
    """ # noqa: E501
    payload: Optional[StrictStr] = Field(default=None, description="The payload associated with the postback.")
    ...
    __properties: ClassVar[List[str]] = ["payload", "metadata"]
