...
class WebUpdate(object):
    ...
    def can_user_see_conversation_list(self):
        """Gets the can_user_see_conversation_list of this WebUpdate.  # noqa: E501
        ...
        :return: The can_user_see_conversation_list of this WebUpdate.  # noqa: E501
        :rtype: bool
        """
    ...
    def can_user_see_conversation_list(self, can_user_see_conversation_list):
        """Sets the can_user_see_conversation_list of this WebUpdate.

        Allows users to view their list of conversations. By default, the list of conversations will be visible. *This setting only applies to apps where `settings.multiConvoEnabled` is set to `true`*.   # noqa: E501

        :param can_user_see_conversation_list: The can_user_see_conversation_list of this WebUpdate.  # noqa: E501
        :type: bool
        """
