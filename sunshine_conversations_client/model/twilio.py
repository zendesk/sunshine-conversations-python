...
class Twilio(Integration):
    ...
    def __init__(self, default_responder_id=Undefined(), default_responder=Undefined(), type='twilio', account_sid=None, auth_token=Undefined(), phone_number_sid=None, messaging_service_sid=None, local_vars_configuration=None, **kwargs):  # noqa: E501
