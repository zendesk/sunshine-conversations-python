...
class ConversationMessageDeliveryPayloadExternalMessagesInner(BaseModel):
    """
    ConversationMessageDeliveryPayloadExternalMessagesInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="A string representing the ID of the external message.")
