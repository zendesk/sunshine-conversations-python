...
class MessageWebhook(BaseModel):
    ...
    source: Optional[MessageWebhookSource] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "received", "author", "content", "source", "quotedMessage", "metadata", "deleted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": MessageWebhookSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
