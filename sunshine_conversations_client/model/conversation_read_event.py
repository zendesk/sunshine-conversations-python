...
class ConversationReadEvent(BaseModel):
    ...
    payload: Optional[ConversationReadEventAllOfPayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payload": ConversationReadEventAllOfPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
