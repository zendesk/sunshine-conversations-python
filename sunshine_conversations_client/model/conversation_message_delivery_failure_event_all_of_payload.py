...
class ConversationMessageDeliveryFailureEventAllOfPayload(BaseModel):
    """
    ...
    error: Optional[ConversationMessageDeliveryFailureEventAllOfPayloadAllOfError] = None
    __properties: ClassVar[List[str]] = ["user", "conversation", "message", "destination", "externalMessages", "isFinalEvent", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": ConversationMessageDeliveryFailureEventAllOfPayloadAllOfError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
