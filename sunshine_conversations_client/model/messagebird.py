...
class Messagebird(Integration):
    ...
    def __init__(self, default_responder_id=Undefined(), default_responder=Undefined(), type='messagebird', access_key=Undefined(), signing_key=Undefined(), originator=None, webhook_secret=None, local_vars_configuration=None, **kwargs):  # noqa: E501
