...
class Messagebird(Integration):
    ...
    def __init__(self, type='messagebird', access_key=None, signing_key=None, originator=None, webhook_secret=None, default_responder_id=Undefined(), default_responder=None, local_vars_configuration=None, **kwargs):  # noqa: E501
