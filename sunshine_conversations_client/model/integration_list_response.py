...
class IntegrationListResponse(BaseModel):
    ...
    """ # noqa: E501
    integrations: Optional[List[Integration]] = Field(default=None, description="List of returned integrations.")
    meta: Optional[Meta] = None
    links: Optional[Links] = None
    __properties: ClassVar[List[str]] = ["integrations", "meta", "links"]
