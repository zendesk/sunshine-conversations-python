...
class TwilioAllOf(object):
    ...
    def __init__(self, type='twilio', account_sid=None, auth_token=Undefined(), phone_number_sid=None, messaging_service_sid=None, local_vars_configuration=None):  # noqa: E501
