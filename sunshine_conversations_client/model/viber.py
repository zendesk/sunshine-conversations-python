...
class Viber(Integration):
    ...
    def __init__(self, type='viber', token=Undefined(), uri=None, account_id=None, default_responder_id=Undefined(), default_responder=Undefined(), local_vars_configuration=None, **kwargs):  # noqa: E501
