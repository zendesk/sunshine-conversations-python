...
class Viber(Integration):
    ...
    def __init__(self, default_responder_id=Undefined(), default_responder=Undefined(), type='viber', token=Undefined(), uri=None, account_id=None, local_vars_configuration=None, **kwargs):  # noqa: E501
