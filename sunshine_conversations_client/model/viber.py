...
class Viber(Integration):
    ...
    type: Optional[StrictStr] = Field(default='viber', description="To configure a Viber integration, acquire the Viber Public Account token from the user and call the Create Integration endpoint. ")
    token: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="Viber Public Account token.")
    uri: Optional[StrictStr] = Field(default=None, description="Unique URI of the Viber account.")
    account_id: Optional[StrictStr] = Field(default=None, description="Unique ID of the Viber account.", alias="accountId")
    __properties: ClassVar[List[str]] = ["id", "type", "status", "displayName", "defaultResponderId", "defaultResponder", "token", "uri", "accountId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'viber',
