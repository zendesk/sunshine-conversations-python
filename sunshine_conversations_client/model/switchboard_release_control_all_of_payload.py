...
class SwitchboardReleaseControlAllOfPayload(BaseModel):
    """
    The payload of the event. The contents of this object depend on the type of event.
    """ # noqa: E501
    conversation: Optional[ConversationTruncated] = Field(default=None, description="The conversation from which the switchboard event was fired. The payload will omit `activeSwitchboardIntegration`, representing that no switchboard integration is in control of the conversation.")
    ...
    reason: Optional[StrictStr] = Field(default=None, description="Reason for the release control action, if applicable.")
