...
class InstagramConversionEventsBody(BaseModel):
    """
    InstagramConversionEventsBody
    """ # noqa: E501
    instagram: Optional[MetaConversionEvent] = None
    __properties: ClassVar[List[str]] = ["instagram"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instagram": MetaConversionEvent.from_dict(obj["instagram"]) if obj.get("instagram") is not None else None
        })
        return _obj
