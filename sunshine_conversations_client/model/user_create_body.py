...
class UserCreateBody(object):
    ...
    def __init__(self, external_id=None, signed_up_at=None, profile=None, metadata=Undefined(), local_vars_configuration=None):  # noqa: E501
    ...
    def external_id(self):
        ...
        A unique identifier for the user. The `externalId` can be used to link a user to the same conversation [across multiple devices](https://docs.smooch.io/guide/authenticating-users/).   # noqa: E501
