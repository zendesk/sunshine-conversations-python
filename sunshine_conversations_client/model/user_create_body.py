...
class UserCreateBody(BaseModel):
    ...
    UserCreateBody
    """ # noqa: E501
    external_id: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="A unique identifier for the user. The `externalId` can be used to link a user to the same conversation [across multiple devices](https://developer.zendesk.com/documentation/conversations/messaging-platform/users/authenticating-users/). ", alias="externalId")
    ...
    __properties: ClassVar[List[str]] = ["externalId", "signedUpAt", "toBeRetained", "profile", "metadata"]
