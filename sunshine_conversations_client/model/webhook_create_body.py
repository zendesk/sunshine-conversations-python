...
class WebhookCreateBody(object):
    ...
    def __init__(self, target=None, triggers=None, include_full_user=False, include_full_source=False, local_vars_configuration=None):  # noqa: E501
        """WebhookCreateBody - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def target(self):
        """Gets the target of this WebhookCreateBody.  # noqa: E501

        URL to be called when the webhook is triggered.  # noqa: E501

        :return: The target of this WebhookCreateBody.  # noqa: E501
        :rtype: str
        """
        return self._target
    ...
    def target(self, target):
        """Sets the target of this WebhookCreateBody.

        URL to be called when the webhook is triggered.  # noqa: E501

        :param target: The target of this WebhookCreateBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def triggers(self):
        """Gets the triggers of this WebhookCreateBody.  # noqa: E501

        An array of triggers the integration is subscribed to. This property is case sensitive. [More details](https://developer.zendesk.com/api-reference/conversations/#section/Webhook-Triggers).  # noqa: E501

        :return: The triggers of this WebhookCreateBody.  # noqa: E501
        :rtype: List[str]
        """
    ...
    def triggers(self, triggers):
        """Sets the triggers of this WebhookCreateBody.

        An array of triggers the integration is subscribed to. This property is case sensitive. [More details](https://developer.zendesk.com/api-reference/conversations/#section/Webhook-Triggers).  # noqa: E501

        :param triggers: The triggers of this WebhookCreateBody.  # noqa: E501
        :type: List[str]
        """
    ...
    def include_full_user(self):
        """Gets the include_full_user of this WebhookCreateBody.  # noqa: E501
        ...
        :return: The include_full_user of this WebhookCreateBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def include_full_user(self, include_full_user):
        """Sets the include_full_user of this WebhookCreateBody.

        A boolean specifying whether webhook payloads should include the complete user schema for events involving a specific user.  # noqa: E501

        :param include_full_user: The include_full_user of this WebhookCreateBody.  # noqa: E501
        :type: bool
        """
    ...
    def include_full_source(self):
        """Gets the include_full_source of this WebhookCreateBody.  # noqa: E501

        A boolean specifying whether webhook payloads should include the client and device object (when applicable).  # noqa: E501

        :return: The include_full_source of this WebhookCreateBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def include_full_source(self, include_full_source):
        """Sets the include_full_source of this WebhookCreateBody.

        A boolean specifying whether webhook payloads should include the client and device object (when applicable).  # noqa: E501

        :param include_full_source: The include_full_source of this WebhookCreateBody.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebhookCreateBody):
            return False
