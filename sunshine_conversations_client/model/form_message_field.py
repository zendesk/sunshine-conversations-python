...
class FormMessageField(object):
    ...
    def options(self, options):
        ...
        :type: List[FormOptionsInner]
        """
        if (self.local_vars_configuration.client_side_validation and
                options is not None and len(options) > 200):
            raise ValueError("Invalid value for `options`, number of items must be less than or equal to `200`")  # noqa: E501
