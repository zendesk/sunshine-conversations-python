...
class IosUpdateAllOf(object):
    ...
    def __init__(self, certificate=Undefined(), password=None, production=None, auto_update_badge=None, can_user_see_conversation_list=None, can_user_create_more_conversations=None, local_vars_configuration=None):  # noqa: E501
    ...
    def can_user_see_conversation_list(self):
        """Gets the can_user_see_conversation_list of this IosUpdateAllOf.  # noqa: E501
        ...
        :return: The can_user_see_conversation_list of this IosUpdateAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def can_user_see_conversation_list(self, can_user_see_conversation_list):
        """Sets the can_user_see_conversation_list of this IosUpdateAllOf.

        Allows users to view their list of conversations. By default, the list of conversations will be visible. *This setting only applies to apps where `settings.multiConvoEnabled` is set to `true`*.   # noqa: E501

        :param can_user_see_conversation_list: The can_user_see_conversation_list of this IosUpdateAllOf.  # noqa: E501
        :type: bool
        """
