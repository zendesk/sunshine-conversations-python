...
class User(object):
    ...
    def __init__(self, id=None, external_id=Undefined(), signed_up_at=None, to_be_retained=None, profile=None, metadata=None, identities=None, local_vars_configuration=None):  # noqa: E501
