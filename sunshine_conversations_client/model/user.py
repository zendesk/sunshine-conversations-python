...
class User(object):
    ...
    def user_external_id(self):
        """Gets the user_external_id of this User.  # noqa: E501

        The externalId of the user. Only supported when `type` is user.  # noqa: E501

        :return: The user_external_id of this User.  # noqa: E501
        :rtype: str
        """
    ...
    def user_external_id(self, user_external_id):
        """Sets the user_external_id of this User.

        The externalId of the user. Only supported when `type` is user.  # noqa: E501

        :param user_external_id: The user_external_id of this User.  # noqa: E501
        :type: str
        """
