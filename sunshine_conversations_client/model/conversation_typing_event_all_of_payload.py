...
class ConversationTypingEventAllOfPayload(BaseModel):
    """
    The payload of the event. The contents of this object depend on the type of event.
    """ # noqa: E501
    conversation: Optional[ConversationTruncated] = Field(default=None, description="The conversation in which the activity was sent.")
    activity: Optional[ConversationTypingEventAllOfPayloadActivity] = None
    __properties: ClassVar[List[str]] = ["conversation", "activity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activity": ConversationTypingEventAllOfPayloadActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None
        })
        return _obj
