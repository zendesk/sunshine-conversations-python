...
class MessagePost(object):
    ...
    def __init__(self, author=None, content=None, destination=None, metadata=Undefined(), override=None, var_schema=None, local_vars_configuration=None):  # noqa: E501
    ...
    def var_schema(self, var_schema):
        """Sets the var_schema of this MessagePost.

        When `schema` is set to `\"whatsapp\"`, the `content` key is expected to conform to the [native WhatsApp schema](https://developers.facebook.com/docs/whatsapp/api/messages/message-templates) for sending message templates. For more details, consult the documentation for [sending message templates on WhatsApp](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/message-overrides/#template-messages).   # noqa: E501

        :param var_schema: The var_schema of this MessagePost.  # noqa: E501
        :type: str
        """
