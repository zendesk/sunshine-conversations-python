...
class MessagePost(object):
    ...
    def __init__(self, author=None, content=None, destination=None, metadata=Undefined(), override=None, message_schema=None, local_vars_configuration=None):  # noqa: E501
    ...
    def message_schema(self):
        """Gets the message_schema of this MessagePost.  # noqa: E501
        ...
        :return: The message_schema of this MessagePost.  # noqa: E501
        :rtype: str
        """
    ...
    def message_schema(self, message_schema):
        """Sets the message_schema of this MessagePost.

        Send WhatsApp Message Templates using \"whatsapp\", while populating the message key using the native [WhatsApp schema](https://developers.facebook.com/docs/whatsapp/api/messages/message-templates). When the `messageSchema` is specified, the message is automatically converted to the Sunshine Conversations schema to be stored in the conversation record. The Sunshine Conversations message schema is also used in the API response. Go to [Post Message API](https://docs.smooch.io/guide/whatsapp/#post-message-api) to view an example.   # noqa: E501

        :param message_schema: The message_schema of this MessagePost.  # noqa: E501
        :type: str
        """
