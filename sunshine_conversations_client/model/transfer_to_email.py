...
class TransferToEmail(object):
    ...
    @property
    def type(self):
        """Gets the type of this TransferToEmail.  # noqa: E501
        ...
        :return: The type of this TransferToEmail.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TransferToEmail.

        The type of system activity that generated the message. The value of this field determines the dynamic content that is rendered to the end-user / agent when viewing this message. Each `type` value will have a set of pre-defined, localized strings that describe the activity.  # noqa: E501

        :param type: The type of this TransferToEmail.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransferToEmail):
            return False
