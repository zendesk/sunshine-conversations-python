...
class MessengerUpdate(BaseModel):
    ...
    page_access_token: Optional[StrictStr] = Field(default=None, description="A Facebook Page Access Token.", alias="pageAccessToken")
    __properties: ClassVar[List[str]] = ["displayName", "defaultResponderId", "pageAccessToken"]
