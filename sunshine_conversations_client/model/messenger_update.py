...
class MessengerUpdate(object):
    ...
    def display_name(self):
        """Gets the display_name of this MessengerUpdate.  # noqa: E501

        A human-friendly name used to identify the integration. `displayName` can be unset by changing it to `null`.  # noqa: E501

        :return: The display_name of this MessengerUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this MessengerUpdate.

        A human-friendly name used to identify the integration. `displayName` can be unset by changing it to `null`.  # noqa: E501

        :param display_name: The display_name of this MessengerUpdate.  # noqa: E501
        :type: str
        """
    ...
    def default_responder_id(self):
        """Gets the default_responder_id of this MessengerUpdate.  # noqa: E501
        ...
        :return: The default_responder_id of this MessengerUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def default_responder_id(self, default_responder_id):
        """Sets the default_responder_id of this MessengerUpdate.

        The default responder ID for the integration. This is the ID of the responder that will be used to send messages to the user. For more information, refer to <a href=\"https://docs.smooch.io/guide/switchboard/#per-channel-default-responder\">Per-channel default responder</a> guide.   # noqa: E501

        :param default_responder_id: The default_responder_id of this MessengerUpdate.  # noqa: E501
        :type: str
        """
    ...
    def page_access_token(self):
        """Gets the page_access_token of this MessengerUpdate.  # noqa: E501

        A Facebook Page Access Token.  # noqa: E501

        :return: The page_access_token of this MessengerUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def page_access_token(self, page_access_token):
        """Sets the page_access_token of this MessengerUpdate.

        A Facebook Page Access Token.  # noqa: E501

        :param page_access_token: The page_access_token of this MessengerUpdate.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessengerUpdate):
            return False
