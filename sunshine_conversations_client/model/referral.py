...
class Referral(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The referral’s identifier.")
    details: Optional[ReferralDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "details": ReferralDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
