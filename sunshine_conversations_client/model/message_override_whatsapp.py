...
class MessageOverrideWhatsapp(BaseModel):
    """
    MessageOverrideWhatsapp
    """ # noqa: E501
    whatsapp: Optional[MessageOverridePayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "whatsapp": MessageOverridePayload.from_dict(obj["whatsapp"]) if obj.get("whatsapp") is not None else None
        })
        return _obj
