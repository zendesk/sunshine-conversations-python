...
class Telegram(Integration):
    ...
    def __init__(self, type='telegram', token=None, username=None, bot_id=None, default_responder_id=Undefined(), default_responder=None, local_vars_configuration=None, **kwargs):  # noqa: E501
