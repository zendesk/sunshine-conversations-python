...
class Telegram(Integration):
    ...
    def __init__(self, default_responder_id=Undefined(), default_responder=Undefined(), type='telegram', token=Undefined(), username=None, bot_id=None, local_vars_configuration=None, **kwargs):  # noqa: E501
