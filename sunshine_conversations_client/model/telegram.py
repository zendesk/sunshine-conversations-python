...
class Telegram(Integration):
    ...
    type: Optional[StrictStr] = Field(default='telegram', description="To configure a Telegram integration, acquire the required information from the user and call the Create Integration endpoint. ")
    token: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="Telegram Bot Token.")
    username: Optional[StrictStr] = Field(default=None, description="Username of the botId")
    bot_id: Optional[StrictStr] = Field(default=None, description="A human-friendly name used to identify the integration.", alias="botId")
    __properties: ClassVar[List[str]] = ["id", "type", "status", "displayName", "defaultResponderId", "defaultResponder", "token", "username", "botId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'telegram',
