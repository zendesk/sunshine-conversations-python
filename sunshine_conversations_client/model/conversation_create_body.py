...
class ConversationCreateBody(object):
    ...
    def __init__(self, type=None, participants=None, display_name=Undefined(), description=Undefined(), icon_url=Undefined(), metadata=Undefined(), local_vars_configuration=None):  # noqa: E501
    ...
    def participants(self, participants):
        ...
        if (self.local_vars_configuration.client_side_validation and
                participants is not None and len(participants) > 10):
            raise ValueError("Invalid value for `participants`, number of items must be less than or equal to `10`")  # noqa: E501
