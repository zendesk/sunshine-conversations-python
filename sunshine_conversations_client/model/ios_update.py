...
class IosUpdate(BaseModel):
    ...
    certificate: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="The binary of your APN certificate base64 encoded.")
    ...
    __properties: ClassVar[List[str]] = ["displayName", "defaultResponderId", "certificate", "password", "production", "autoUpdateBadge", "canUserSeeConversationList", "canUserCreateMoreConversations"]
