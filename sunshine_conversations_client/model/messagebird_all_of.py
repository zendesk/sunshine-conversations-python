...
class MessagebirdAllOf(object):
    ...
    def __init__(self, type='messagebird', access_key=Undefined(), signing_key=Undefined(), originator=None, webhook_secret=None, local_vars_configuration=None):  # noqa: E501
