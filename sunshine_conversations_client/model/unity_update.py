...
class UnityUpdate(object):
    ...
    def __init__(self, display_name=Undefined(), default_responder_id=Undefined(), can_user_create_more_conversations=None, local_vars_configuration=None):  # noqa: E501
