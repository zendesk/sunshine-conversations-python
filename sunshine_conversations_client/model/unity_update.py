...
class UnityUpdate(object):
    ...
    def __init__(self, display_name=Undefined(), default_responder_id=Undefined(), can_user_see_conversation_list=None, can_user_create_more_conversations=None, local_vars_configuration=None):  # noqa: E501
    ...
    def default_responder_id(self):
        """Gets the default_responder_id of this UnityUpdate.  # noqa: E501
        ...
        :return: The default_responder_id of this UnityUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def default_responder_id(self, default_responder_id):
        """Sets the default_responder_id of this UnityUpdate.

        The default responder ID for the integration. This is the ID of the responder that will be used to send messages to the user. For more information, refer to <a href=\"https://docs.smooch.io/guide/switchboard/#per-channel-default-responder\">Per-channel default responder</a> guide.   # noqa: E501

        :param default_responder_id: The default_responder_id of this UnityUpdate.  # noqa: E501
        :type: str
        """
    ...
    def can_user_see_conversation_list(self):
        """Gets the can_user_see_conversation_list of this UnityUpdate.  # noqa: E501
        ...
        :return: The can_user_see_conversation_list of this UnityUpdate.  # noqa: E501
        :rtype: bool
        """
    ...
    def can_user_see_conversation_list(self, can_user_see_conversation_list):
        """Sets the can_user_see_conversation_list of this UnityUpdate.

        Allows users to view their list of conversations. By default, the list of conversations will be visible. *This setting only applies to apps where `settings.multiConvoEnabled` is set to `true`*.   # noqa: E501

        :param can_user_see_conversation_list: The can_user_see_conversation_list of this UnityUpdate.  # noqa: E501
        :type: bool
        """
