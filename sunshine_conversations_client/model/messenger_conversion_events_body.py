...
class MessengerConversionEventsBody(BaseModel):
    """
    MessengerConversionEventsBody
    """ # noqa: E501
    messenger: Optional[MetaConversionEvent] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messenger": MetaConversionEvent.from_dict(obj["messenger"]) if obj.get("messenger") is not None else None
        })
        return _obj
