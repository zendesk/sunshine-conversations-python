...
class IntegrationListFilter(BaseModel):
    """
    IntegrationListFilter
    """ # noqa: E501
    types: Optional[StrictStr] = Field(default=None, description="Comma-separated list of types to return. If omitted, all types are returned.")
