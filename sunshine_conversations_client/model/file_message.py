...
class FileMessage(object):
    ...
    def __init__(self, type='file', media_url=None, media_size=None, media_type=None, alt_text=None, text=None, block_chat_input=None, html_text=None, markdown_text=None, attachment_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def block_chat_input(self):
        """Gets the block_chat_input of this FileMessage.  # noqa: E501
        ...
        :return: The block_chat_input of this FileMessage.  # noqa: E501
        :rtype: bool
        """
    ...
    def block_chat_input(self, block_chat_input):
        """Sets the block_chat_input of this FileMessage.

        When set to true, the chat input will be disabled on supported client implementations when the message is the most recent one in the history. Can be used for guided flows or to temporarily disable the user's ability to send messages in the conversation.  # noqa: E501

        :param block_chat_input: The block_chat_input of this FileMessage.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def html_text(self):
        """Gets the html_text of this FileMessage.  # noqa: E501
        ...
        :return: The html_text of this FileMessage.  # noqa: E501
        :rtype: str
        """
    ...
    def html_text(self, html_text):
        """Sets the html_text of this FileMessage.

        HTML text content of the message. Can be provided in place of `text`. Cannot be used with `markdownText`. If no `text` is provided, will be converted to `text` upon reception to be displayed on channels that do not support rich text. See [rich text](https://docs.smooch.io/guide/structured-messages/rich-text) documentation for more information.  # noqa: E501

        :param html_text: The html_text of this FileMessage.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def markdown_text(self):
        """Gets the markdown_text of this FileMessage.  # noqa: E501
        ...
        :return: The markdown_text of this FileMessage.  # noqa: E501
        :rtype: str
        """
    ...
    def markdown_text(self, markdown_text):
        """Sets the markdown_text of this FileMessage.

        Markdown text content of the message. Can be provided in place of `text`. Cannot be used with `htmlText`. Will be converted to `htmlText` upon reception. If converted `htmlText` exceeds 4096 characters, the message will be rejected. If no `text` is provided, will be converted to `text` upon reception to be displayed on channels that do not support rich text. See [rich text](https://docs.smooch.io/guide/structured-messages/rich-text) documentation for more information.  # noqa: E501

        :param markdown_text: The markdown_text of this FileMessage.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
