...
class FileMessage(object):
    ...
    def __init__(self, type='file', media_url=None, media_size=None, media_type=None, alt_text=None, text=None, html_text=None, markdown_text=None, attachment_id=None, local_vars_configuration=None):  # noqa: E501
