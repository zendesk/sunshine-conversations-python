...
class Item(object):
    ...
    def __init__(self, title=None, description=None, media_url=None, media_type=None, size=None, actions=None, metadata=Undefined(), local_vars_configuration=None):  # noqa: E501
