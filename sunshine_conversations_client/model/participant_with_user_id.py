...
class ParticipantWithUserId(BaseModel):
    """
    ParticipantWithUserId
    """ # noqa: E501
    user_id: Optional[StrictStr] = Field(default=None, description="The id of the user that will be participating in the conversation. It will return `404` if the user can’t be found. One of `userId` or `userExternalId` is required, but not both.", alias="userId")
    ...
    __properties: ClassVar[List[str]] = ["userId", "subscribeSDKClient"]
