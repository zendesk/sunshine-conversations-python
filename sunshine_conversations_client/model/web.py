...
class Web(Integration):
    ...
    type: Optional[StrictStr] = Field(default='web', description="To configure a Web Messenger integration, acquire the required information and call the Create Integration endpoint. ")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "status", "displayName", "defaultResponderId", "defaultResponder", "brandColor", "fixedIntroPane", "conversationColor", "actionColor", "displayStyle", "buttonIconUrl", "buttonWidth", "buttonHeight", "integrationOrder", "businessName", "businessIconUrl", "backgroundImageUrl", "originWhitelist", "prechatCapture", "canUserSeeConversationList", "canUserCreateMoreConversations", "attachmentsEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'web',
