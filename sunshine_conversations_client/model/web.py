...
class Web(Integration):
    ...
    def __init__(self, default_responder_id=Undefined(), default_responder=Undefined(), type='web', brand_color='65758e', fixed_intro_pane=False, conversation_color='0099ff', action_color='0099ff', display_style='button', button_icon_url=Undefined(), button_width='58', button_height='58', integration_order=Undefined(), business_name=None, business_icon_url=None, background_image_url=None, origin_whitelist=Undefined(), prechat_capture=None, can_user_see_conversation_list=None, can_user_create_more_conversations=None, attachments_enabled=None, local_vars_configuration=None, **kwargs):  # noqa: E501
