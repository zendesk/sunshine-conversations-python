...
class ClientUpdateEvent(BaseModel):
    """
    ClientUpdateEvent
    """ # noqa: E501
    ...
    payload: Optional[ClientUpdateEventAllOfPayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payload": ClientUpdateEventAllOfPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
