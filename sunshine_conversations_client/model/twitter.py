...
class Twitter(Integration):
    ...
    def __init__(self, default_responder_id=Undefined(), default_responder=Undefined(), type='twitter', tier=None, env_name=None, consumer_key=None, consumer_secret=Undefined(), access_token_key=None, access_token_secret=Undefined(), local_vars_configuration=None, **kwargs):  # noqa: E501
