...
class SwitchboardAcceptControlFailureAllOfPayload(BaseModel):
    """
    The payload of the event. The contents of this object depend on the type of event.
    """ # noqa: E501
    error: Optional[Dict[str, Any]] = Field(default=None, description="Object containing details of what went wrong.")
    conversation: Optional[ConversationTruncated] = Field(default=None, description="The conversation from which the switchboard event was fired.")
    ...
    __properties: ClassVar[List[str]] = ["error", "conversation", "metadata"]
