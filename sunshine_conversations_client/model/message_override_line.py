...
class MessageOverrideLine(BaseModel):
    """
    MessageOverrideLine
    """ # noqa: E501
    line: Optional[MessageOverridePayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "line": MessageOverridePayload.from_dict(obj["line"]) if obj.get("line") is not None else None
        })
        return _obj
