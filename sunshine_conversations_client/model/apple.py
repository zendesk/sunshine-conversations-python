...
class Apple(Integration):
    ...
    def __init__(self, type='apple', business_id=None, api_secret=None, msp_id=None, authentication_message_secret=None, default_responder_id=Undefined(), default_responder=Undefined(), local_vars_configuration=None, **kwargs):  # noqa: E501
    ...
    def authentication_message_secret(self):
        """Gets the authentication_message_secret of this Apple.  # noqa: E501

        A secret used to create the state value when sending Apple authentication 2.0 messages  # noqa: E501

        :return: The authentication_message_secret of this Apple.  # noqa: E501
        :rtype: str
        """
    ...
    def authentication_message_secret(self, authentication_message_secret):
        """Sets the authentication_message_secret of this Apple.

        A secret used to create the state value when sending Apple authentication 2.0 messages  # noqa: E501

        :param authentication_message_secret: The authentication_message_secret of this Apple.  # noqa: E501
        :type: str
        """
