...
class Apple(Integration):
    ...
    type: Optional[StrictStr] = Field(default='apple', description="To configure an Apple Messages for Business integration, acquire the required information and call the Create Integration endpoint. ")
    business_id: StrictStr = Field(description="Apple Messages for Business ID.", alias="businessId")
    api_secret: StrictStr = Field(description="Your Apple API secret which is tied to your Messaging Service Provider.", alias="apiSecret")
    msp_id: StrictStr = Field(description="Your Messaging Service Provider ID.", alias="mspId")
    authentication_message_secret: Optional[Annotated[str, Field(min_length=88, strict=True)]] = Field(default=None, description="A secret used to create the state value when sending Apple authentication 2.0 messages", alias="authenticationMessageSecret")
    __properties: ClassVar[List[str]] = ["id", "type", "status", "displayName", "defaultResponderId", "defaultResponder", "businessId", "apiSecret", "mspId", "authenticationMessageSecret"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mspId": obj.get("mspId"),
            "authenticationMessageSecret": obj.get("authenticationMessageSecret")
        })
        return _obj
