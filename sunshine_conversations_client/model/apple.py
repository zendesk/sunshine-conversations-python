...
class Apple(Integration):
    ...
    def __init__(self, default_responder_id=Undefined(), default_responder=Undefined(), type='apple', business_id=None, api_secret=None, msp_id=None, authentication_message_secret=None, local_vars_configuration=None, **kwargs):  # noqa: E501
