...
class AppSettings(object):
    ...
    def __init__(self, conversation_retention_seconds=None, mask_credit_card_numbers=None, use_animal_names=None, echo_postback=None, ignore_auto_conversation_start=None, multi_convo_enabled=None, app_localization_enabled=None, local_vars_configuration=None):  # noqa: E501
    ...
    def use_animal_names(self):
        ...
        A boolean specifying whether animal names should be used for  unnamed users. See the  [user naming guide](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/receiving-messages/#message-author-name) for details.   # noqa: E501
