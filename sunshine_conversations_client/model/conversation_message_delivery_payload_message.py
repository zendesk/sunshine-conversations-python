...
class ConversationMessageDeliveryPayloadMessage(BaseModel):
    """
    The message that was sent.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="A string representing the ID of the message.")
