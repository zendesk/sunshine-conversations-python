...
class WebUpdateAllOf(object):
    ...
    def business_name(self):
        """Gets the business_name of this WebUpdateAllOf.  # noqa: E501

        A custom business name for the Web Messenger.  # noqa: E501

        :return: The business_name of this WebUpdateAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def business_name(self, business_name):
        """Sets the business_name of this WebUpdateAllOf.

        A custom business name for the Web Messenger.  # noqa: E501

        :param business_name: The business_name of this WebUpdateAllOf.  # noqa: E501
        :type: str
        """
    ...
    def business_icon_url(self):
        """Gets the business_icon_url of this WebUpdateAllOf.  # noqa: E501
        ...
        :return: The business_icon_url of this WebUpdateAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def business_icon_url(self, business_icon_url):
        """Sets the business_icon_url of this WebUpdateAllOf.

        A custom business icon url for the Web Messenger. The image must be at least 200 x 200 pixels and must be in either JPG, PNG, or GIF format.  # noqa: E501

        :param business_icon_url: The business_icon_url of this WebUpdateAllOf.  # noqa: E501
        :type: str
        """
    ...
    def background_image_url(self):
        """Gets the background_image_url of this WebUpdateAllOf.  # noqa: E501

        A background image url for the conversation. Image will be tiled to fit the window.  # noqa: E501

        :return: The background_image_url of this WebUpdateAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def background_image_url(self, background_image_url):
        """Sets the background_image_url of this WebUpdateAllOf.

        A background image url for the conversation. Image will be tiled to fit the window.  # noqa: E501

        :param background_image_url: The background_image_url of this WebUpdateAllOf.  # noqa: E501
        :type: str
        """
    ...
    def origin_whitelist(self):
        """Gets the origin_whitelist of this WebUpdateAllOf.  # noqa: E501
        ...
        :return: The origin_whitelist of this WebUpdateAllOf.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def origin_whitelist(self, origin_whitelist):
        """Sets the origin_whitelist of this WebUpdateAllOf.

        A list of origins to whitelist. When set, only the origins from this list will be able to initialize the Web Messenger. If unset, all origins are whitelisted. The elements in the list should follow the serialized-origin format from RFC 6454: scheme \"://\" host [ \":\" port ], where scheme is http or https.   # noqa: E501

        :param origin_whitelist: The origin_whitelist of this WebUpdateAllOf.  # noqa: E501
        :type: list[str]
        """
    ...
    def prechat_capture(self):
        """Gets the prechat_capture of this WebUpdateAllOf.  # noqa: E501
        ...
        :return: The prechat_capture of this WebUpdateAllOf.  # noqa: E501
    ...
    def prechat_capture(self, prechat_capture):
        """Sets the prechat_capture of this WebUpdateAllOf.

        Object whose properties can be set to specify the add-on’s options. See the [guide](https://docs.smooch.io/guide/web-messenger/#prechat-capture) to learn more about Prechat Capture.  # noqa: E501

        :param prechat_capture: The prechat_capture of this WebUpdateAllOf.  # noqa: E501
        :type: PrechatCapture
        """
    ...
    def can_user_see_conversation_list(self):
        """Gets the can_user_see_conversation_list of this WebUpdateAllOf.  # noqa: E501
        ...
        :return: The can_user_see_conversation_list of this WebUpdateAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def can_user_see_conversation_list(self, can_user_see_conversation_list):
        """Sets the can_user_see_conversation_list of this WebUpdateAllOf.

        Allows users to view their list of conversations. By default, the list of conversations will be visible. *This setting only applies to apps where `settings.multiConvoEnabled` is set to `true`*.   # noqa: E501

        :param can_user_see_conversation_list: The can_user_see_conversation_list of this WebUpdateAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def can_user_create_more_conversations(self):
        """Gets the can_user_create_more_conversations of this WebUpdateAllOf.  # noqa: E501

        Allows users to create more than one conversation on the web messenger integration.  # noqa: E501

        :return: The can_user_create_more_conversations of this WebUpdateAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def can_user_create_more_conversations(self, can_user_create_more_conversations):
        """Sets the can_user_create_more_conversations of this WebUpdateAllOf.

        Allows users to create more than one conversation on the web messenger integration.  # noqa: E501

        :param can_user_create_more_conversations: The can_user_create_more_conversations of this WebUpdateAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebUpdateAllOf):
            return False
