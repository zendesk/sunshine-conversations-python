...
class Android(Integration):
    ...
    def __init__(self, type='android', project_id=Undefined(), client_email=Undefined(), private_key=Undefined(), server_key=Undefined(), sender_id=Undefined(), can_user_see_conversation_list=None, can_user_create_more_conversations=None, attachments_enabled=None, default_responder_id=Undefined(), default_responder=None, local_vars_configuration=None, **kwargs):  # noqa: E501
    ...
    def can_user_see_conversation_list(self):
        """Gets the can_user_see_conversation_list of this Android.  # noqa: E501
        ...
        :return: The can_user_see_conversation_list of this Android.  # noqa: E501
        :rtype: bool
        """
    ...
    def can_user_see_conversation_list(self, can_user_see_conversation_list):
        """Sets the can_user_see_conversation_list of this Android.

        Allows users to view their list of conversations. By default, the list of conversations will be visible. *This setting only applies to apps where `settings.multiConvoEnabled` is set to `true`*.   # noqa: E501

        :param can_user_see_conversation_list: The can_user_see_conversation_list of this Android.  # noqa: E501
        :type: bool
        """
