...
class ImageMessage(BaseModel):
    ...
    media_type: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="The type of media.", alias="mediaType")
    media_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The size of the media in bytes.", alias="mediaSize")
    alt_text: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="An optional description of the image for accessibility purposes. The field will be saved by default with the file name as the value.", alias="altText")
    ...
    __properties: ClassVar[List[str]] = ["type", "mediaUrl", "mediaType", "mediaSize", "altText", "text", "blockChatInput", "htmlText", "markdownText", "actions", "attachmentId"]
