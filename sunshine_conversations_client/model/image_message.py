...
class ImageMessage(object):
    ...
    def __init__(self, type='image', media_url=None, media_type=None, media_size=None, alt_text=None, text=None, block_chat_input=None, html_text=None, markdown_text=None, actions=None, attachment_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def block_chat_input(self):
        """Gets the block_chat_input of this ImageMessage.  # noqa: E501
        ...
        :return: The block_chat_input of this ImageMessage.  # noqa: E501
        :rtype: bool
        """
    ...
    def block_chat_input(self, block_chat_input):
        """Sets the block_chat_input of this ImageMessage.

        When set to true, the chat input will be disabled on supported client implementations when the message is the most recent one in the history. Can be used for guided flows or to temporarily disable the user's ability to send messages in the conversation.  # noqa: E501

        :param block_chat_input: The block_chat_input of this ImageMessage.  # noqa: E501
        :type: bool
        """
