...
class ImageMessage(object):
    ...
    def __init__(self, type='image', media_url=None, media_type=None, media_size=None, alt_text=None, text=None, actions=None, local_vars_configuration=None):  # noqa: E501
