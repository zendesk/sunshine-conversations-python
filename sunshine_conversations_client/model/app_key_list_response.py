...
class AppKeyListResponse(BaseModel):
    ...
    AppKeyListResponse
    """ # noqa: E501
    keys: Optional[List[AppKey]] = Field(default=None, description="List of returned keys.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [AppKey.from_dict(_item) for _item in obj["keys"]] if obj.get("keys") is not None else None
        })
        return _obj
