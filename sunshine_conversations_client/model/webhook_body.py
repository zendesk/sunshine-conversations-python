...
class WebhookBody(BaseModel):
    ...
    WebhookBody
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description="URL to be called when the webhook is triggered.")
    triggers: Optional[List[StrictStr]] = Field(default=None, description="An array of triggers the integration is subscribed to. This property is case sensitive. [More details](https://developer.zendesk.com/api-reference/conversations/#section/Webhook-Triggers).")
    ...
    __properties: ClassVar[List[str]] = ["target", "triggers", "includeFullUser", "includeFullSource"]
