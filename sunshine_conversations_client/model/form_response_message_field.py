...
class FormResponseMessageField(BaseModel):
    """
    ...
    quoted_message_id: Optional[StrictStr] = Field(default=None, description="The messageId for the form that this response belongs to.", alias="quotedMessageId")
    __properties: ClassVar[List[str]] = ["type", "name", "label", "text", "email", "select", "quotedMessageId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quotedMessageId": obj.get("quotedMessageId")
        })
        return _obj
