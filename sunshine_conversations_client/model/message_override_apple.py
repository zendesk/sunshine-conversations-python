...
class MessageOverrideApple(BaseModel):
    """
    MessageOverrideApple
    """ # noqa: E501
    apple: Optional[AppleMessageOverridePayload] = None
    __properties: ClassVar[List[str]] = ["apple"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apple": AppleMessageOverridePayload.from_dict(obj["apple"]) if obj.get("apple") is not None else None
        })
        return _obj
