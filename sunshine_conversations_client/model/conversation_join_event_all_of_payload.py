...
class ConversationJoinEventAllOfPayload(BaseModel):
    """
    The payload of the event. The contents of this object depend on the type of event.
    """ # noqa: E501
    conversation: Optional[ConversationTruncated] = Field(default=None, description="The conversation in which the user was added.")
    user: Optional[UserTruncated] = Field(default=None, description="The user that joined the conversation.")
