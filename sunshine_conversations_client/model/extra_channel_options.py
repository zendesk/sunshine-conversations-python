...
class ExtraChannelOptions(BaseModel):
    """
    Extra options to pass directly to the channel API.
    """ # noqa: E501
    messenger: Optional[ExtraChannelOptionsMessenger] = None
    __properties: ClassVar[List[str]] = ["messenger"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messenger": ExtraChannelOptionsMessenger.from_dict(obj["messenger"]) if obj.get("messenger") is not None else None
        })
        return _obj
