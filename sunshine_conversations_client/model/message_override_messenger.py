...
class MessageOverrideMessenger(BaseModel):
    """
    MessageOverrideMessenger
    """ # noqa: E501
    messenger: Optional[MessageOverridePayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messenger": MessageOverridePayload.from_dict(obj["messenger"]) if obj.get("messenger") is not None else None
        })
        return _obj
