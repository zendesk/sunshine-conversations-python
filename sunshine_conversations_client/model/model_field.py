...
class ModelField(object):
    ...
    def __init__(self, type=None, name=None, label=None, text=None, email=None, select=None, local_vars_configuration=None):  # noqa: E501
        """ModelField - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this ModelField.  # noqa: E501

        The field type.  # noqa: E501

        :return: The type of this ModelField.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this ModelField.  # noqa: E501
        :type: str
        """
    ...
    @property
    def label(self):
        """Gets the label of this ModelField.  # noqa: E501

        The label of the field. What the field is displayed as on Web Messenger.  # noqa: E501

        :return: The label of this ModelField.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        ...
        :param label: The label of this ModelField.  # noqa: E501
        :type: str
        """
    ...
    @property
    def text(self):
        """Gets the text of this ModelField.  # noqa: E501

        Specifies the response for a text field.  # noqa: E501

        :return: The text of this ModelField.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this ModelField.

        Specifies the response for a text field.  # noqa: E501

        :param text: The text of this ModelField.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def email(self):
        """Gets the email of this ModelField.  # noqa: E501

        Specifies the response for a email field.  # noqa: E501

        :return: The email of this ModelField.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this ModelField.

        Specifies the response for a email field.  # noqa: E501

        :param email: The email of this ModelField.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def select(self, select):
        """Sets the select of this ModelField.

        Array of objects representing the response for a field of type select. Form and formResponse messages only.  # noqa: E501

        :param select: The select of this ModelField.  # noqa: E501
        :type: List[object]
        """
