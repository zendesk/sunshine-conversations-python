...
class DefaultResponderDefaultResponder(object):
    ...
    def __init__(self, name=None, integration_id=None, integration_type=None, deliver_standby_events=None, next_switchboard_integration_id=Undefined(), message_history_count=None, inherited=None, local_vars_configuration=None):  # noqa: E501
    ...
    def name(self):
        ...
        The name of the switchboard integration.  # noqa: E501
    ...
    def inherited(self):
        ...
        Indicates whether the default responder is inherited from the switchboard's global config or not. Returns `false` if a per-channel responder override has been set for this integration, and `true` otherwise.  # noqa: E501
