...
class Instagram(Integration):
    ...
    def __init__(self, default_responder_id=Undefined(), default_responder=Undefined(), type='instagram', page_access_token=Undefined(), app_id=None, app_secret=Undefined(), business_name=None, business_username=None, page_id=None, business_id=None, username=None, user_id=None, local_vars_configuration=None, **kwargs):  # noqa: E501
