...
class Mailgun(Integration):
    ...
    def __init__(self, type='mailgun', api_key=Undefined(), domain=None, incoming_address=None, hide_unsubscribe_link=None, from_address=Undefined(), default_responder_id=Undefined(), default_responder=Undefined(), local_vars_configuration=None, **kwargs):  # noqa: E501
