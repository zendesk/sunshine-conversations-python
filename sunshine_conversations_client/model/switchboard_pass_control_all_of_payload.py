...
class SwitchboardPassControlAllOfPayload(BaseModel):
    """
    The payload of the event. The contents of this object depend on the type of event.
    """ # noqa: E501
    conversation: Optional[ConversationTruncated] = Field(default=None, description="The conversation from which the switchboard event was fired. On success, the payload will include an `activeSwitchboardIntegration`, representing the switchboard integration that is now in control of the conversation.")
    ...
    reason: Optional[StrictStr] = Field(default=None, description="Reason for the pass control action, if applicable.")
    __properties: ClassVar[List[str]] = ["conversation", "metadata", "reason"]
