...
class ConversationListResponse(BaseModel):
    ...
    """ # noqa: E501
    conversations: Optional[List[Conversation]] = Field(default=None, description="List of returned conversations.")
    meta: Optional[Meta] = None
    links: Optional[Links] = None
    __properties: ClassVar[List[str]] = ["conversations", "meta", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversations": [Conversation.from_dict(_item) for _item in obj["conversations"]] if obj.get("conversations") is not None else None,
