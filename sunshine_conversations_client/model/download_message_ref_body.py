...
try:
    DownloadMessageRefBodyAllOf = __import__("sunshine_conversations_client.model."+re.sub(r'(?<!^)(?=[A-Z])', '_', "DownloadMessageRefBodyAllOf").lower(), fromlist=("DownloadMessageRefBodyAllOf")).DownloadMessageRefBodyAllOf
except ImportError:
    pass
