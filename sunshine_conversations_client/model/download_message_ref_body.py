...
class DownloadMessageRefBody(BaseModel):
    """
    DownloadMessageRefBody
    """ # noqa: E501
    user_id: StrictStr = Field(description="The id of the user.", alias="userId")
    apple: Optional[DownloadMessageRefBodyAllOfApple] = None
    __properties: ClassVar[List[str]] = ["userId", "apple"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apple": DownloadMessageRefBodyAllOfApple.from_dict(obj["apple"]) if obj.get("apple") is not None else None
        })
        return _obj
