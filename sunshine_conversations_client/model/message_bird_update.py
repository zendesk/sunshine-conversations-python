...
class MessageBirdUpdate(object):
    ...
    def display_name(self):
        """Gets the display_name of this MessageBirdUpdate.  # noqa: E501

        A human-friendly name used to identify the integration. `displayName` can be unset by changing it to `null`.  # noqa: E501

        :return: The display_name of this MessageBirdUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this MessageBirdUpdate.

        A human-friendly name used to identify the integration. `displayName` can be unset by changing it to `null`.  # noqa: E501

        :param display_name: The display_name of this MessageBirdUpdate.  # noqa: E501
        :type: str
        """
    ...
    def default_responder_id(self):
        """Gets the default_responder_id of this MessageBirdUpdate.  # noqa: E501
        ...
        :return: The default_responder_id of this MessageBirdUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def default_responder_id(self, default_responder_id):
        """Sets the default_responder_id of this MessageBirdUpdate.

        The default responder ID for the integration. This is the ID of the responder that will be used to send messages to the user. For more information, refer to the <a href=\"https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/switchboard/#default-integration-assignment\">Switchboard guide</a>.   # noqa: E501

        :param default_responder_id: The default_responder_id of this MessageBirdUpdate.  # noqa: E501
        :type: str
        """
