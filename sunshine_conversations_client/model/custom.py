...
class Custom(Integration):
    ...
    def webhooks(self, webhooks):
        ...
        if (self.local_vars_configuration.client_side_validation and
                webhooks is not None and len(webhooks) > 1):
            raise ValueError("Invalid value for `webhooks`, number of items must be less than or equal to `1`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                webhooks is not None and len(webhooks) < 1):
            raise ValueError("Invalid value for `webhooks`, number of items must be greater than or equal to `1`")  # noqa: E501
