...
class QuotedMessageMessage(BaseModel):
    """
    QuotedMessageMessage
    """ # noqa: E501
    type: StrictStr = Field(description="The type of quotedMessage - a complete Sunshine Conversations message is provided.")
...
QuotedMessageMessage.model_rebuild(raise_errors=False)
