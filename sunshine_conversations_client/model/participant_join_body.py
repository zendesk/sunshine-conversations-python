...
class ParticipantJoinBody(object):
    ...
    def __init__(self, user_id=None, subscribe_sdk_client=None, user_external_id=None, local_vars_configuration=None):  # noqa: E501
        """ParticipantJoinBody - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def user_id(self):
        """Gets the user_id of this ParticipantJoinBody.  # noqa: E501
        ...
        :return: The user_id of this ParticipantJoinBody.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this ParticipantJoinBody.

        The id of the user that will be participating in the conversation. It will return `404` if the user can’t be found. One of `userId` or `userExternalId` is required, but not both.  # noqa: E501

        :param user_id: The user_id of this ParticipantJoinBody.  # noqa: E501
        :type: str
        """
    ...
    def subscribe_sdk_client(self):
        """Gets the subscribe_sdk_client of this ParticipantJoinBody.  # noqa: E501
        ...
        :return: The subscribe_sdk_client of this ParticipantJoinBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def subscribe_sdk_client(self, subscribe_sdk_client):
        """Sets the subscribe_sdk_client of this ParticipantJoinBody.

        When passed as true, the SDK client of the concerned participant will be subscribed to the conversation. The user will start receiving push notifications for this conversation right away, without having to view the conversation on the SDK beforehand. An SDK client will be created for users that don’t already have one. This field is required if the conversation is of type `sdkGroup`.  # noqa: E501

        :param subscribe_sdk_client: The subscribe_sdk_client of this ParticipantJoinBody.  # noqa: E501
        :type: bool
        """
    ...
    def user_external_id(self):
        """Gets the user_external_id of this ParticipantJoinBody.  # noqa: E501
        ...
        :return: The user_external_id of this ParticipantJoinBody.  # noqa: E501
        :rtype: str
        """
    ...
    def user_external_id(self, user_external_id):
        """Sets the user_external_id of this ParticipantJoinBody.

        The `externalId` of the user that will be participating in the conversation. It will return `404` if the user can’t be found. One of `userId` or `userExternalId` is required, but not both.  # noqa: E501

        :param user_external_id: The user_external_id of this ParticipantJoinBody.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ParticipantJoinBody):
            return False
