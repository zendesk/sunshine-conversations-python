...
try:
    ParticipantSubSchema = __import__("sunshine_conversations_client.model."+re.sub(r'(?<!^)(?=[A-Z])', '_', "ParticipantSubSchema").lower(), fromlist=("ParticipantSubSchema")).ParticipantSubSchema
except ImportError:
    pass
