...
class Postback(BaseModel):
    ...
    payload: StrictStr = Field(description="The payload of a postback or reply button.")
    ...
    __properties: ClassVar[List[str]] = ["type", "text", "payload", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'postback',
            "text": obj.get("text"),
