...
class ConversationTruncated(object):
    ...
    def __init__(self, id=None, type=None, active_switchboard_integration=Undefined(), pending_switchboard_integration=Undefined(), local_vars_configuration=None):  # noqa: E501
