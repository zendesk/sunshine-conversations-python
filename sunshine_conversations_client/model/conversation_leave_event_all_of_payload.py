...
class ConversationLeaveEventAllOfPayload(BaseModel):
    """
    The payload of the event. The contents of this object depend on the type of event.
    """ # noqa: E501
    conversation: Optional[ConversationTruncated] = Field(default=None, description="The conversation in which the user was removed.")
    user: Optional[UserTruncated] = Field(default=None, description="The user that left the conversation.")
    __properties: ClassVar[List[str]] = ["conversation", "user"]
