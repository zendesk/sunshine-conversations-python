...
class ConversationsApi(object):
    ...
    def delete_conversation(self, app_id, conversation_id, **kwargs):  # noqa: E501
        ...
        Delete an entire conversation record, along with its messages and attachments. Note that the default conversation cannot be deleted, but the messages contained [can be](#operation/DeleteAllMessages).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def download_message_ref(self, app_id, conversation_id, download_message_ref_body, **kwargs):  # noqa: E501
        """Download Message Ref  # noqa: E501

        When a third party channel provides a reference of a data, this API can be used to download the reference and fetch the full data. Currently, only apple channel is supported.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_message_ref(app_id, conversation_id, download_message_ref_body, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str app_id: Identifies the app. (required)
        :param str conversation_id: Identifies the conversation. (required)
        :param DownloadMessageRefBody download_message_ref_body: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.download_message_ref_with_http_info(app_id, conversation_id, download_message_ref_body, **kwargs)  # noqa: E501

    def download_message_ref_with_http_info(self, app_id, conversation_id, download_message_ref_body, **kwargs):  # noqa: E501
        """Download Message Ref  # noqa: E501

        When a third party channel provides a reference of a data, this API can be used to download the reference and fetch the full data. Currently, only apple channel is supported.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_message_ref_with_http_info(app_id, conversation_id, download_message_ref_body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method download_message_ref" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'app_id' is set
        if self.api_client.client_side_validation and ('app_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['app_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `app_id` when calling `download_message_ref`")  # noqa: E501
        # verify the required parameter 'conversation_id' is set
        if self.api_client.client_side_validation and ('conversation_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['conversation_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `conversation_id` when calling `download_message_ref`")  # noqa: E501
        # verify the required parameter 'download_message_ref_body' is set
        if self.api_client.client_side_validation and ('download_message_ref_body' not in local_var_params or  # noqa: E501
                                                        local_var_params['download_message_ref_body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `download_message_ref_body` when calling `download_message_ref`")  # noqa: E501
        ...
        body_params = None
        if 'download_message_ref_body' in local_var_params:
            body_params = local_var_params['download_message_ref_body']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def post_conversion_events(self, app_id, conversation_id, conversion_events_body, **kwargs):  # noqa: E501
        """Post Conversion Events  # noqa: E501

        This API can be used to track your end user's interactions with third party channels.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_conversion_events(app_id, conversation_id, conversion_events_body, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str app_id: Identifies the app. (required)
        :param str conversation_id: Identifies the conversation. (required)
        :param ConversionEventsBody conversion_events_body: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.post_conversion_events_with_http_info(app_id, conversation_id, conversion_events_body, **kwargs)  # noqa: E501

    def post_conversion_events_with_http_info(self, app_id, conversation_id, conversion_events_body, **kwargs):  # noqa: E501
        """Post Conversion Events  # noqa: E501

        This API can be used to track your end user's interactions with third party channels.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_conversion_events_with_http_info(app_id, conversation_id, conversion_events_body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_conversion_events" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'app_id' is set
        if self.api_client.client_side_validation and ('app_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['app_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `app_id` when calling `post_conversion_events`")  # noqa: E501
        # verify the required parameter 'conversation_id' is set
        if self.api_client.client_side_validation and ('conversation_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['conversation_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `conversation_id` when calling `post_conversion_events`")  # noqa: E501
        # verify the required parameter 'conversion_events_body' is set
        if self.api_client.client_side_validation and ('conversion_events_body' not in local_var_params or  # noqa: E501
                                                        local_var_params['conversion_events_body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `conversion_events_body` when calling `post_conversion_events`")  # noqa: E501
        ...
        body_params = None
        if 'conversion_events_body' in local_var_params:
            body_params = local_var_params['conversion_events_body']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
