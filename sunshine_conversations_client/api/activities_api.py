...
class ActivitiesApi:
    ...
    def post_activity(
        ...
        :param activity_post: (required)
        :type activity_post: ActivityPost
        ...
        _param = self._post_activity_serialize(
            app_id=app_id,
    ...
    @validate_call
    def post_activity_with_http_info(
        self,
        app_id: Annotated[StrictStr, Field(description="Identifies the app.")],
        conversation_id: Annotated[StrictStr, Field(description="Identifies the conversation.")],
        activity_post: ActivityPost,
    ...
    @validate_call
    def post_activity_without_preload_content(
        self,
        app_id: Annotated[StrictStr, Field(description="Identifies the app.")],
        conversation_id: Annotated[StrictStr, Field(description="Identifies the conversation.")],
        activity_post: ActivityPost,
    ...
    def _post_activity_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/apps/{appId}/conversations/{conversationId}/activity',
