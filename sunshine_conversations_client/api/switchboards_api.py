...
class SwitchboardsApi:
    ...
    def create_switchboard(
        ...
        _param = self._create_switchboard_serialize(
            app_id=app_id,
    ...
    @validate_call
    def create_switchboard_with_http_info(
        self,
        app_id: Annotated[StrictStr, Field(description="Identifies the app.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SwitchboardResponse]:
        """Create Switchboard
    ...
    @validate_call
    def create_switchboard_without_preload_content(
        self,
        app_id: Annotated[StrictStr, Field(description="Identifies the app.")],
        _request_timeout: Union[
            None,
    ...
    def _create_switchboard_serialize(
        self,
        app_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/apps/{appId}/switchboards',
    ...
    def delete_switchboard(
        ...
        _param = self._delete_switchboard_serialize(
            app_id=app_id,
    ...
    @validate_call
    def delete_switchboard_with_http_info(
        self,
        app_id: Annotated[StrictStr, Field(description="Identifies the app.")],
        switchboard_id: Annotated[StrictStr, Field(description="Identifies the switchboard.")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_switchboard_without_preload_content(
        self,
        app_id: Annotated[StrictStr, Field(description="Identifies the app.")],
        switchboard_id: Annotated[StrictStr, Field(description="Identifies the switchboard.")],
        _request_timeout: Union[
    ...
    def _delete_switchboard_serialize(
        self,
        app_id,
        switchboard_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v2/apps/{appId}/switchboards/{switchboardId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_switchboards(
        ...
        _param = self._list_switchboards_serialize(
            app_id=app_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_switchboards_with_http_info(
        self,
        app_id: Annotated[StrictStr, Field(description="Identifies the app.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SwitchboardListResponse]:
        """List Switchboards
    ...
    @validate_call
    def list_switchboards_without_preload_content(
        self,
        app_id: Annotated[StrictStr, Field(description="Identifies the app.")],
        _request_timeout: Union[
            None,
    ...
    def _list_switchboards_serialize(
        self,
        app_id,
        _request_auth,
        _content_type,
    ...
    def update_switchboard(
        ...
        :param switchboard_id: Identifies the switchboard. (required)
        :type switchboard_id: str
        :param switchboard_update_body: (required)
        :type switchboard_update_body: SwitchboardUpdateBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_switchboard_serialize(
            app_id=app_id,
            switchboard_id=switchboard_id,
            switchboard_update_body=switchboard_update_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_switchboard_with_http_info(
        self,
        app_id: Annotated[StrictStr, Field(description="Identifies the app.")],
        switchboard_id: Annotated[StrictStr, Field(description="Identifies the switchboard.")],
        switchboard_update_body: SwitchboardUpdateBody,
    ...
    @validate_call
    def update_switchboard_without_preload_content(
        self,
        app_id: Annotated[StrictStr, Field(description="Identifies the app.")],
        switchboard_id: Annotated[StrictStr, Field(description="Identifies the switchboard.")],
        switchboard_update_body: SwitchboardUpdateBody,
    ...
    def _update_switchboard_serialize(
        self,
        app_id,
        switchboard_id,
        ...
        # process the form parameters
        # process the body parameter
        if switchboard_update_body is not None:
            _body_params = switchboard_update_body
